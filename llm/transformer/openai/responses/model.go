...
type Tool struct {
	// Type identifies a Responses tool declaration, including function, custom,
	// namespace, tool_search, web_search, image_generation, and future opaque types.
	...
	// DeferLoading marks a function as discoverable through tool search.
...
type Item struct {
	...
	// Type identifies a Responses input, output, or tool-catalog item, including
	// messages, reasoning, function/custom/tool-search calls and outputs,
	// additional_tools catalogs, compaction, and image-generation items.
	Type string `json:"type,omitempty"`
	...
	// Tools is used by additional_tools and tool_search_output items.
	Tools []Tool `json:"tools,omitempty"`
